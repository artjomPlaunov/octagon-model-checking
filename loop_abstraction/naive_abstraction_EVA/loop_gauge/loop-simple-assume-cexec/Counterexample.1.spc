...
STATE USEFIRST ARG28 :
    MATCH "__VERIFIER_assert(x <= 3000003 && y <= 2000002);" -> GOTO ARG29;
    TRUE -> STOP;

STATE USEFIRST ARG29 :
    MATCH "[x <= 3000003]" -> GOTO ARG30;
    MATCH "[!(x <= 3000003)]" -> GOTO ARG34;
    TRUE -> STOP;

STATE USEFIRST ARG30 :
    MATCH "[y <= 2000002]" -> GOTO ARG32;
    MATCH "[!(y <= 2000002)]" -> GOTO ARG34;
    TRUE -> STOP;

STATE USEFIRST ARG32 :
    MATCH "x <= 3000003 && y <= 2000002" -> GOTO ARG37;
    TRUE -> STOP;
...
STATE USEFIRST ARG37 :
    MATCH "__VERIFIER_assert(x <= 3000003 && y <= 2000002);" -> GOTO ARG38;
    TRUE -> STOP;
