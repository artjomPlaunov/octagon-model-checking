...
STATE USEFIRST ARG89 :
    MATCH "__VERIFIER_assume(x <= 3000000 && y <= 2000000);" -> GOTO ARG108;
    TRUE -> STOP;

STATE USEFIRST ARG108 :
    MATCH "[x <= 3000000]" -> GOTO ARG109;
    MATCH "[!(x <= 3000000)]" -> GOTO ARG113;
    TRUE -> STOP;

STATE USEFIRST ARG109 :
    MATCH "[y <= 2000000]" -> GOTO ARG111;
    MATCH "[!(y <= 2000000)]" -> GOTO ARG113;
    TRUE -> STOP;

STATE USEFIRST ARG111 :
    MATCH "x <= 3000000 && y <= 2000000" -> GOTO ARG116;
    TRUE -> STOP;
...
STATE USEFIRST ARG116 :
    MATCH "[__VERIFIER_assume(x <= 3000000 && y <= 2000000);]" -> GOTO ARG117;
    TRUE -> STOP;

STATE USEFIRST ARG117 :
    MATCH "x = x;" -> GOTO ARG119_1_4;
STATE USEFIRST ARG119_0_4 :
    MATCH "x = x;" -> GOTO ARG119_1_4;
STATE USEFIRST ARG119_1_4 :
    MATCH "y = y;" -> GOTO ARG119;
    TRUE -> STOP;

STATE USEFIRST ARG119 :
    MATCH "[!(flag)]" -> GOTO ARG120;
    MATCH "[flag]" -> GOTO ARG121;
    TRUE -> STOP;

STATE USEFIRST ARG120 :
    MATCH "y += 2;" -> GOTO ARG124;
    TRUE -> STOP;

STATE USEFIRST ARG121 :
    MATCH "x += 3;" -> GOTO ARG122;
    TRUE -> STOP;
...
STATE USEFIRST ARG129 :
    MATCH "[!(i < n)]" -> GOTO ARG131;
    TRUE -> STOP;

STATE USEFIRST ARG131 :
    MATCH "__VERIFIER_assert(x <= 3000003 && y <= 2000002);" -> GOTO ARG132;
    TRUE -> STOP;

STATE USEFIRST ARG132 :
    MATCH "[x <= 3000003]" -> GOTO ARG133;
    MATCH "[!(x <= 3000003)]" -> GOTO ARG137;
    TRUE -> STOP;

STATE USEFIRST ARG133 :
    MATCH "[y <= 2000002]" -> GOTO ARG135;
    MATCH "[!(y <= 2000002)]" -> GOTO ARG137;
    TRUE -> STOP;

STATE USEFIRST ARG135 :
    MATCH "x <= 3000003 && y <= 2000002" -> GOTO ARG140;
    TRUE -> STOP;
...
STATE USEFIRST ARG140 :
    MATCH "__VERIFIER_assert(x <= 3000003 && y <= 2000002);" -> GOTO ARG141;
    TRUE -> STOP;
